...
# 系数来自 DP8ConstantCache 的精确版本 (Julia 文件 high_order_rk_tableaus.jl)
_DP8_C = np.array([
    0.0,                     # c1
    1/18,                    # c2
    1/12,                    # c3
...
# stage 12 – corrected using exact decimal values from high_order_rk_tableaus.jl
_DP8_A[11,0] = 2.2733101475165382
_DP8_A[11,3] = -10.53449546673725
_DP8_A[11,4] = -2.0008720582248625
_DP8_A[11,5] = -17.9589318631188
_DP8_A[11,6] = 27.94888452941996
_DP8_A[11,7] = -2.8589982771350237
...
# Error coefficients er = b_high - b_low (from DP8ConstantCache)
_DP8_ER = np.array([
    0.01312004499419488,             # er1
    0.0,                             # er2
    0.0,                             # er3
    0.0,                             # er4
    0.0,                             # er5
    -1.2251564463762044,             # er6
    -0.4957589496572502,             # er7
    1.6643771824549864,              # er8
    -0.35032884874997366,            # er9
    0.3341791187130175,              # er10
    0.08192320648511571,             # er11
    -0.022355307863886294            # er12
], dtype=np.float64)

_DP8_B_LOW = _DP8_B_HIGH - _DP8_ER

TABLE_DP8 = RKTable(s=12, C=_DP8_C, A=_DP8_A,
                    B_high=_DP8_B_HIGH, B_low=_DP8_B_LOW, btilde=None, order=8)
